...
2. **Continuous Deployment (GitHub/GitLab)**:
   - Connect your repository to Netlify.
   - Set the **Build Command** to: `npm run build`
   - Set the **Publish directory** to: `dist`
   - Add any environment variables (like Gemini API keys) in the Netlify dashboard under **Site settings > Build & deploy > Environment**.
